...
SCPinstal="$HOME/install"
  ...
  # check root
[[ $EUID -ne 0 ]] && echo -e "Este script debe ejecutarse como usuario root！\n" && exit 1
...
wget -O /usr/share/cowsay/cows/bart.cow https://www.dropbox.com/s/ky7neai02i7xwby/bart.cow &> /dev/null
clear
msg -bar2
figlet VPS MX | lolcat
 echo -e " "
msg -bar2
msg -bra "[ NEW - ULTIMATE - SCRIPT ] ➣ \033[1;33m[\033[1;34m BY MORDRER\033\033[1;33m]\033[0m"
echo ""
[[ $1 = "" ]] && funcao_idioma || {
